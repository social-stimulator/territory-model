...
;; All colours of agents steal from each other's clans - done with two
;; Slider to determine how many agents in each clan  - DONE
;; reporter for the total resources available for each color
;; claim-territory needs to be a seperate command - we just ask them to do it under various conditions - DONE
;; change sequence of actions to see who steals first - blue or green ?
...
;; next iteration with all 4 colors
...
to steal-blue-green ;; blue clan steals from green clan
  ask blue-agent [
...
to steal-green-blue ;; green clan steals from blue clan
ask green-agent [
...
"" ""
PENS
"Green Patches" 1.0 0 -15040220 true "" "plot count patches with [pcolor = green ]"
"Blue Patches" 1.0 0 -14070903 true "" "plot count patches with [pcolor = blue ]"
"Black Patches" 1.0 0 -16644859 true "" "plot count patches with [pcolor = black ]"
