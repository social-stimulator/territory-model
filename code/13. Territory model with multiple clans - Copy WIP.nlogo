...
;; Once stolen, the land belongs to the stealing clan

;; Additions to be made ;;
;; Turtles move in a more strategic way, have visibility of larger area to determine where to move
;; Resources get replenished - maybe based on how much consumption is happening
;; will be so interesting when we add reproduction
;; individual energy comparision with min-one-of agents, or with the entire clan?
;; add feature for retaliation : if red-attacks-green, green-attacks-red
...
"Yellow Patches" 1.0 0 -4079321 true "" "plot count patches with [pcolor = yellow ]"
"Red Patches " 1.0 0 -5298144 true "" "plot count patches with [pcolor = red ]"
